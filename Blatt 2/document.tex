...
\begin{enumerate}[a)] 
	...
	% Irgendwie habe ich das Gefühl, dass Equal-Sum ein Spezialfall des Subset-Sum-Problems ist. Wenn wir nämlich bei Subset-Sum die gewünschte Gesamtsumme W auf die Hälfte der Summe der Menge aller Zahlen in S setzt, wird zwangsläufig das Equal-Sum Problem gelöst. Damit wäre aber EQUAL-SUM \leq_p SUBSET-SUM und nicht anders herum, wie wir es gerne hätten. :D 
